...
public final class AtualizarExcluirCliente extends javax.swing.JFrame {
    ...
    public void LoadTable(){
        ...
        ArrayList<String[]> linhasClientes = CadastrarClienteController.getClientes();
    ...
    private void btnExcluirClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirClienteActionPerformed
        if(tblClientes.getRowCount()>0)
        {
            ...
            if(CadastrarClienteController.Excluir(Integer.parseInt(tblClientes.getValueAt(numeroLinha,0).toString()) ) )
            {
                this.LoadTable();
